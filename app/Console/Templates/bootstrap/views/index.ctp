...
<div class="<?php echo $pluralVar; ?> index panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo "<?php echo __('{$pluralHumanName}'); ?>"; ?></h3>
    </div>
    <div class="panel-body">
        <?php echo "<?php echo \$this->Form->create(null, array('type' => 'get', 'class' => 'form-inline', 'inputDefaults' => array('div' => false, 'label' => false))); ?>\n" ?>
        <fieldset>
        <?php
        echo "<?php 
        ...
        <table cellpadding="0" cellspacing="0" class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                <?php
                echo "\t<?php foreach (\${$pluralVar} as \$order => \${$singularVar}): ?>\n";
                echo "\t\t\t\t\t<tr>\n";
                echo "\t\t\t\t\t\t<td><?php echo \$order + 1; ?>&nbsp;</td>\n";
